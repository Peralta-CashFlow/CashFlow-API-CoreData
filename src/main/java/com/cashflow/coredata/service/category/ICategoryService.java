...
public interface ICategoryService {
    ...
    CategorySummaryResponse registerCategory(BaseRequest<CategoryCreationRequest> baseRequest, Long userId) throws CashFlowException;
    PageResponse<CategorySummaryResponse> listCategories(PageRequest<Void> request, Long userId);
